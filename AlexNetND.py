...
class AlexNetND(nn.Module):
    def __init__(self, num_classes: int = 10, dropout: float = 0.5) -> None:
        ...
        self.features = nn.Sequential(
            ...
            nn.Conv2d(8, 16, kernel_size=2, padding=2),
            nn.ReLU(inplace=True),
            nn.MaxPool2d(kernel_size=2, stride=2),
...
def alexnet(*, weights: Optional[AlexNet_Weights] = None, progress: bool = True, **kwargs: Any) -> AlexNetND:
